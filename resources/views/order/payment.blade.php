        ...
        <form action="{{ route('front.payment_confirm') }}" method="POST" enctype="multipart/form-data"
         class="relative flex flex-col w-full max-w-[640px] min-h-screen gap-5 mx-auto bg-[#F5F5F0]">
            ...
            <section id="your-order" class="accordion flex flex-col rounded-[20px] p-4 pb-5 gap-5 mx-4 bg-white overflow-hidden transition-all duration-300 has-[:checked]:!h-[66px]">
                ...
                <div class="flex items-center justify-between">
                    <p class="font-semibold">Size & Color</p>
            ...
            <section id="send-payment-to" class="accordion flex flex-col rounded-[20px] p-4 pb-5 gap-5 mx-4 bg-white overflow-hidden transition-all duration-300 has-[:checked]:!h-[66px]">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex items-center gap-3">
                        <div class="flex shrink-0 w-[71px] h-[50px] overflow-hidden">
                            <img src="{{ asset('assets/images/logos/bank-bni.svg') }}" class="w-full h-full object-contain" alt="Bank BNI Logo">
                        </div>
                        <div class="flex flex-col gap-[2px]">
                            <p class="font-semibold flex items-center">StoreJimsHoney <img src="{{ asset('assets/images/icons/verify.svg') }}" class="ml-1" alt="Verify Icon"></p>
                            <p>8008129839</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="flex shrink-0 w-[71px] h-[50px] overflow-hidden">
                            <img src="{{ asset('assets/images/logos/bca-bank-central-asia 1.svg') }}" class="w-full h-full object-contain" alt="Bank BCA Logo">
                        </div>
                        <div class="flex flex-col gap-[2px]">
                            <p class="font-semibold flex items-center">StoreJimsHoney <img src="{{ asset('assets/images/icons/verify.svg') }}" class="ml-1" alt="Verify Icon"></p>
                            <p>8008129839</p>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex shrink-0 w-[71px] h-[50px] overflow-hidden">
                            <img src="{{ asset('assets/images/logos/bank-mandiri 1.svg') }}" class="w-full h-full object-contain" alt="Bank Mandiri Logo">
                        </div>
                        <div class="flex flex-col gap-[2px]">
                            <p class="font-semibold flex items-center">StoreJimsHoney <img src="{{ asset('assets/images/icons/verify.svg') }}" class="ml-1" alt="Verify Icon"></p>
                            <p>12379834983281</p>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex shrink-0 w-[71px] h-[50px] overflow-hidden">
                            <img src="{{ asset('assets/images/logos/Dana.svg') }}" class="w-full h-full object-contain" alt="Dana Logo">
                        </div>
                        <div class="flex flex-col gap-[2px]">
                            <p class="font-semibold flex items-center">StoreJimsHoney <img src="{{ asset('assets/images/icons/verify.svg') }}" class="ml-1" alt="Verify Icon"></p>
                            <p>12379834983281</p>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex shrink-0 w-[71px] h-[50px] overflow-hidden">
                            <img src="{{ asset('assets/images/logos/SeaBank.svg') }}" class="w-full h-full object-contain" alt="SeaBank Logo">
                        </div>
                        <div class="flex flex-col gap-[2px]">
                            <p class="font-semibold flex items-center">StoreJimsHoney <img src="{{ asset('assets/images/icons/verify.svg') }}" class="ml-1" alt="Verify Icon"></p>
                            <p>12379834983281</p>
                ...
                <div class="flex items-center gap-[10px]">
                    ...
                    <p class="leading-[26px]">
                        Kami sangat menghargai privasi Anda dan terus berkomitmen untuk melindungi informasi pribadi yang Anda bagikan dengan kami.
                    </p>
                </div>
            </section>
                ...
                <div class="fixed bottom-5 w-full max-w-[640px] z-30 px-4">
                    <div class="flex items-center justify-between rounded-full bg-[#2A2A2A] p-[10px] pl-6">
                        <div class="flex flex-col gap-[2px] mr-2">
                            <p class="text-white">Apakah anda sudah membayar?</p>
                        </div>
